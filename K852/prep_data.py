...
#    cobs2 = cobs.loc[cobs.apply(lambda x: x.datetime.year == 2024 and x.layer == 2, axis=1), :]
...
#        df.index = df.pop("tag")
#        for tag in ["greater_than-compact3"]:#"greater_than-compact1", "greater_than-compact2",
